...
public class SaveData
{
    ...
    public List<String> WorkingGenerators {get; set;} = new List<string>();
    public List<String> OpenedDoors {get; set;} = new List<string>(); //the doors without keys; like coded, powered up etc
